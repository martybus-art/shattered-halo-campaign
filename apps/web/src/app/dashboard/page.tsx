      ...
      <div className="space-y-6">
        ...
        <Card title="My Campaigns">
          ...
          <p className="mt-2 text-xs text-parchment/60">
            Share deep links like <span className="text-brass">/dashboard?campaign=&lt;id&gt;</span>.
          </p>
        </Card>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <Card title="Your Status">
              <div className="space-y-2 text-parchment/85">
                ...
                <div className="pt-2 border-t border-brass/20">
                  ...
                  <div>
                    <span className="text-brass">Location (secret):</span> {state.current_zone_key} – {state.current_sector_key}
                  </div>
            ...
            <Card title="Catch-up Choice (Underdog)">
              <p className="text-parchment/80">
                If flagged as <span className="text-brass">Underdog</span>, choose one benefit for the round:
              </p>
              <select
              ...
              <p className="mt-2 text-parchment/70 text-sm">
                Next step: persist choice per round and apply via automation.
              </p>
            </Card>
            ...
            <Card title="Recaps & Whispers">
              <div className="space-y-3">
                ...
                <button
                  className="w-full px-4 py-2 rounded bg-blood/20 border border-blood/40 hover:bg-blood/30"
