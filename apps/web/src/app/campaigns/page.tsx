...
export default function CampaignsPage() {
  ...
  const generateNarrative = async () => {
    ...
    const prompt = [
      ...
      ``,
      `The campaign setting is newly rediscovered ${layoutLabel}, lost for millennia and only now re-emerging into galactic awareness.`,
      ...
      ``,
        `Use the tone of ancient, ominous 40K campaign flavour text: mythic, grimdark, mysterious, and evocative.`,
        `The setting should feel like a dead civilisation’s wound in reality — not merely a battlefield, but a place of buried purpose, broken history, and half-understood power.`,
        `Imply that it may contain relics, vaults, prophecy-engines, warp scars, sealed horrors, forgotten machines, or other truths no faction fully understands.`,
        `Suggest that this place was not simply lost by time, but shattered, sealed, abandoned, or broken by some forgotten catastrophe.`,
        `Make it clear that multiple factions would each believe something vital lies here, but avoid naming specific factions so the narrative stays broadly usable.`,
        `Reference at least 3 of the specific location names above naturally within the paragraph.`,
        `Write it as immersive flavour text, not as instructions, summary, or exposition list.`,
        `Explain why this ${isShipLayout ? "vessel" : "location"} was lost and why it matters now`,
        `Avoid clichés like “for millennia it slept” unless phrased in a more original way.`,
        ``,
        `Output only the paragraph. No title. No bullet points. No preamble.`,
    ].join("\n");
